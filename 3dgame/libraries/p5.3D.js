(function (root, factory) {
  ...
  p5.prototype.Object3D = function (
    p,
    depth,
    size,
    resolution,
  ...
  p5.prototype.createWord3D = function (
    string,
    depth = 6,
    size = 10,
    resolution = 50,
    ...
    return new p5.prototype.Word3D(
      (p = this),
      string,
      depth,
      size,
  ...
  p5.prototype.Picture3D = function (
    p,
    picture,
    depth,
    size,
  ...
  p5.prototype.createPicture3D = function (
    picture,
    depth = 6,
    size = 10,
    resolution = 50,
    ...
    return new p5.prototype.Picture3D(
      (p = this),
      picture,
      depth,
      size,
  ...
  p5.prototype.Canvas3D = function (
    p,
    canvas,
    depth,
    size,
  ...
  p5.prototype.createCanvas3D = function (
    picture,
    depth = 6,
    size = 10,
    resolution = 50,
    ...
    return new p5.prototype.Canvas3D(
      (p = this),
      picture,
      depth,
      size,
  ...
  p5.prototype.getRects = function (array, bevel) {
    ...
    // in array
    var inner = Array(mat.length)
      .fill(0)
      .map((x) => Array(mat.length).fill(0));
    var rects = [];
    ...
    if (bevel) {
      for (var x = 0; x < mat.length; x++) {
        for (var y = 0; y < mat.length; y++) {
          ...
          var notEdge =
            x > 0 && y > 0 && x < mat.length - 1 && y < mat.length - 1;
